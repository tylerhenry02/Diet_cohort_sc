...
##multiplot ####
sc$DietCell <- paste0(sc$Diet, ".", sc$Cell_type) 
multiplot(
  plotColData(sc, y="total_counts", x="Diet"),
  plotColData(sc, y="total_features_by_counts", x="Diet"),
  plotColData(sc, y="pct_counts_feature_control", x="Diet"),
  plotColData(sc, y="pct_counts_Mt", x="Diet"), 
cols = 2)
